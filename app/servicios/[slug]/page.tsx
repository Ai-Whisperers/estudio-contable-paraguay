...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${service.name} | Estudio Contable Paraguay`,
...
export default async function ServicioDetailPage({ params }: Props) {
  ...
  const cta = data.serviciosPage?.cta || {
    ...
    buttonHref: "https://wa.me/595981000000?text=Hola%21%20Quiero%20informaci%C3%B3n%20sobre%20servicios%20contables",
  }
  ...
  return (
    <>
      ...
      <main>
        ...
        <ServiceProcess
          title="Proceso"
          subtitle="Pasos para contratar este servicio"
