    ...
    <>
      ...
      <main>
        <Hero
          ...
          ctaPrimaryHref={data.home.hero.ctaPrimaryHref}
          ctaSecondaryText={data.home.hero.ctaSecondaryText}
          ctaSecondaryHref={data.home.hero.ctaSecondaryHref}
          variant="dark"
        />
        ...
        />
        <PricingSection
          title={data.home.pricing.title}
          subtitle={data.home.pricing.subtitle}
          plans={data.home.pricing.plans}
          ctaText={data.home.pricing.ctaText}
          ctaHref={data.home.pricing.ctaHref}
        />
        <ProcessSection
